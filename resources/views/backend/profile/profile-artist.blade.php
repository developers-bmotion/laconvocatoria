                    ...
                    <div class="tab-pane active" id="m_user_profile_tab_1">
                        <form method="post" action="{{ route('update.profile.artist',auth()->user()->id) }}"
                            ...
                            <div class="m-portlet__body">
                                ...
                                <label for="example-text-input" class="col-2 col-form-label">{{ __('edad') }}</label>
                                <div class="col-2">
                            ...
                            <div class="form-group m-form__group row {{$errors->has('level_id')? 'has-danger':''}}">
                                <label for="example-text-input" class="col-2 col-form-label">{{ __('level') }}</label>
                                <div class="col-7">
